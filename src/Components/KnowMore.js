...
//           <iframe src={videoUrls[currentIndex]} frameborder="0" allowfullscreen></iframe>
//         </div>
      ...
      <div className="container py-3">
        ...
        <div className="video-container">
          <iframe
            ...
            title={`Video ${currentIndex + 1}`} // Use backticks for template literals
            frameBorder="0" // Use camelCase for HTML attributes in JSX
            allowFullScreen // Use camelCase for HTML attributes in JSX
          ></iframe>
        </div>
        ...
        <div className="Checkbox">
          <label>
            <input type="checkbox" name="systomStatus" value="exhibitsSymptomYes" />Yes
          </label>
          <label>
            <input type="checkbox" name="systomStatus" value="exhibitsSymptomNo" />No
          </label>
        </div>
      </div>
